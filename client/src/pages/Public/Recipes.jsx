...
const Recipes = () => {
  ...
  // Local search input (important for debounce)
  ...
  // Fetch recipes when params change
  useEffect(() => {
    fetchRecipes({
      q: query,
      cuisine,
  ...
  const hasFilters =
    query || cuisine || difficulty || mealType;
  ...
  // Page title logic
  const pageTitle =
    mealType || cuisine || 'All Recipes';

  const pageDesc = query
    ? `Search results for "${query}"`
    : 'Explore our collection of chef-crafted recipes';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 py-8">
        ...
        <div className="flex gap-3 mb-6">
          ...
          <button
            ...
            className={`btn-secondary gap-2 border border-surface-300 ${
              showFilters
          ...
          <div className="bg-surface-50 dark:bg-surface-900 border border-surface-200 dark:border-surface-800 rounded-lg p-4 mb-6 grid grid-cols-2 md:grid-cols-4 gap-3">
            ...
            {hasFilters && (
              ...
              <button
                ...
                className="btn-ghost text-sm gap-1 justify-center border border-surface-300 rounded-md"
              >
